...
{{--    Box-image gray secondary--}}
    <div class="bg-[#7A798A] overflow-hidden  object-cover object-center relative w-[290px] h-[290px] rounded-[20px] flex flex-col">
        <div onclick="likeItem({{$item_id}});" class="absolute w-[64px] h-[28px] bg-[#14141F] rounded-[10px] top-[14px] right-[12px] flex justify-center items-center gap-x-[5px] text-white hover:cursor-pointer">
