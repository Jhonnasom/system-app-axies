...
{{--    Box-image gray secondary--}}
    <div onclick="likeItem({{$item_id}});" class="bg-[#7A798A] overflow-hidden  object-cover object-center relative w-[290px] h-[290px] rounded-[20px] flex flex-col">
        <div class="absolute w-[64px] h-[28px] bg-[#14141F] rounded-[10px] top-[14px] right-[12px] flex justify-center items-center gap-x-[5px] text-white hover:cursor-pointer">
            ...
            <span id="counter_item_likes_id_{{$item_id}}">{{$likes}}</span>
        </div>
{{--        Group para el buttom de buy para comprar--}}
    ...
    <div class="w-full flex justify-between mt-[16px]">
        ...
        @endif
        @if($home && $buttons)
            <button class="flex gap-x-2 items-center font-bold text-[#8A8AA0]">
