...
<div class="group w-[330px] h-[442px] bg-[#343444] p-5 rounded-[20px]">
    ...
    <div class="flex">
        ...
        <div class="w-72px h-[49px] flex flex-col items-end ms-[37px]">
            ...
            <span class="text-lg text-white font-bold leading-[26px]">{{$price}} ETH</span>
        </div>
    </div>
</div>
